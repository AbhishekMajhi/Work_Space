...
def load_requirments():
    ...
    print(time.ctime())
    word_to_index, index_to_word, word_to_vec_map = read_glove_vecs('/home/ultimatedude/Documents/Galvin/data and models/glove.6B.200d.txt')
    ultimate_galvin_model = load_model('/home/ultimatedude/Documents/Galvin/data and models/command_iden_model_final_gru.h5')
    print(time.ctime())
    print('done!!')
