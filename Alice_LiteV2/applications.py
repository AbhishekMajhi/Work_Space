...
def open_browser():     ## done
    try:
        ...
        try:
            ...
            speak("Sorry you don't have brave either..")
        speak("Please install any browser")
# 2.5
def browsers():  # to be added
...
# 23  self-intro
def self_intro():
    speak("I am Alice, created by The Dude Bro Organization, I am a Linux AI Assistant,I am here to make your daily linux uses easier.")
...
def get_weather():
    ...
    try:
        ...
        speak(f"Temperature in {city} is {math.floor(cel)} degree celcius")
        # print("Temperature in" + city + "is" + cel)
    except:
        speak("Sorry. The there has been some kind of error occurred during fetching weather data.")
...
def gnome_disk():
    try:
        ...
        speak("Can't open gnome disk or gnome disk not installed yet!")
...
def google(url):
    ...
    try:
        ...
        speak("Something went wrong with web browser package and no action matched.")
